...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-tabs mb-3" role="tablist"> {{-- mb-3 для відступу --}}
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#maindata" role="tab">Основні дані</a> {{-- data-bs-toggle для Bootstrap 5 --}}
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#adddata" role="tab">Додаткові дані</a> {{-- data-bs-toggle для Bootstrap 5 --}}
            </li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="maindata" role="tabpanel">
                <div class="mb-3"> {{-- mb-3 замість form-group --}}
            ...
            <div class="tab-pane" id="adddata" role="tabpanel">
                <div class="mb-3">
                    ...
                    <select name="category_id" id="category_id" class="form-select" required> {{-- form-select для select --}}
                ...
                <div class="form-check mb-3"> {{-- mb-3 для відступу --}}
                    <input type="hidden" name="is_published" value="0"> {{-- Приховане поле для гарантії, що значення 0 буде відправлено, якщо чекбокс не відмічено --}}
